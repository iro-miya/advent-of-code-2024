...
function solve(input: string): number {
	...
	for (const update of updates) {
		// TODO: This solution only works if the problematic numbers are adjacent.
		// This is always the case in the input generated by the challenge, so it works.
		// I think you could fix it by having it traverse the rules for every number that is in the update.
		//
		// Example of input that doesn't work:
		// 1|2
		// 2|3
		// 3|4
		// 4|5
		//
		// 1,4,5,2,3
		// Thanks @mei@donotsta.re for pointing it out!
